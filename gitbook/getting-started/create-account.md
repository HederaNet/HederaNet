...
Open [https://hederanet.online](https://hederanet.online/) in any modern browser. You will land on the home page.
...
> ℹ️ **Your Hedera Account ID** Your account ID looks like `0.0.1234567`. It is your permanent address on the Hedera network. You can view your account at any time on HashScan: `https://hashscan.io/testnet/account/0.0.1234567` The account ID is public — it is safe to share when receiving payments or providing an operator address.
...
Return to [https://hederanet.online](https://hederanet.online/) and click **Sign In**.
