...
> 💡 **Tip:** Use the location picker on the form to drop a pin on the map for accurate coordinates. Accurate coordinates ensure subscribers can find your hotspot on the [Network Map](/map).
